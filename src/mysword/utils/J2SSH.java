...
public class J2SSH {
	...
	public static HashMap<String, Object> exeCommand(String command, String hostname, int port, String username, String password) throws Exception {
	...
	public static String shell(String shells[], String hostname, int port, String username, String password) throws JSchException, IOException, InterruptedException {
		StringBuffer logString = new StringBuffer();
		Channel channel = null;
		Session session = null;
		try {
	...
	public static HashMap<String, Object> exeShell(String shells[], String hostname, int port, String username, String password) throws Exception {
		HashMap<String, Object> resultMap = new HashMap<String, Object>();
    ...
    public static String checkInMapShell(String shells[], String hostname, int port, String username, String password) throws InterruptedException, JSchException, IOException {
        StringBuffer logString = new StringBuffer();
        Channel channel = null;
        Session session = null;
        try {
            ...
            for (int i = 0; i < shells.length; i++) {
                ...
                logString.append(shell_result.toString());
                inputStream.close();
                if(StringUtils.contains(StringUtils.trim(shell_result.toString()), "! ! ! !  Mapping "+shells[i].replace("\n","")+" does not exist for user ")) {
                    break;
                }
                if(StringUtils.contains(StringUtils.trim(shell_result.toString()), "! ! ! !  Please make a new archive  ! ! ! !")) {
                    break;
                }
            }
            outStream.close();
    ...
    public static String getmapShell(String shells[], String hostname, int port, String username, String password) throws InterruptedException, JSchException, IOException {
        StringBuffer logString = new StringBuffer();
        Channel channel = null;
        Session session = null;
        try {
    ...
    public static String rolloutMapShell(String shells[], String hostname, int port, String username, String password) throws JSchException, InterruptedException, IOException {
        StringBuffer logString = new StringBuffer();
        Channel channel = null;
        Session session = null;
        try {
